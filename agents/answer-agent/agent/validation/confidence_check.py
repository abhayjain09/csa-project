...
Note: counts_as / does_not_count keyword checks were removed because those
fields no longer exist as named attributes on QuestionBlock — they are
embedded in raw_text and read by the model directly from the prompt.
"""
