...
#  Targets amd64 to match the ECS task's cpu_architecture (X86_64).
#  On Apple Silicon this cross-builds via emulation (slower than native).
#
#  Usage:
...
REPO_NAME="reportiq"
TAG="${1:-latest}"
ARCH="amd64"   # must match cpu_architecture (X86_64) in tfvars
