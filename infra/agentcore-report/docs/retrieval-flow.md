...
flowchart TD
    ...
    D --> T1["Tier 1: Official registries<br/>SEC EDGAR / Companies House"]
    T1 -->|"Validated report found"| V["Validate company, type, year, source"]
    T1 -->|"No match"| T2["Tier 2: Official company website<br/>sitemap + investor/report pages"]

    T2 -->|"Validated report found"| V
    T2 -->|"No match"| T3["Tier 3: Site-scoped search<br/>official domain only"]

    T3 -->|"Validated report found"| V
    T3 -->|"No match"| T4["Tier 4: AgentCore Browser<br/>Playwright navigation, year selector, download button"]

    T4 -->|"Validated report found"| V
    T4 -->|"No match"| T5["Tier 5: Fargate browser worker<br/>long-running JavaScript navigation"]

    T5 -->|"Report found"| V
    T5 -->|"Login / WAF / CAPTCHA"| M["Manual review required"]
